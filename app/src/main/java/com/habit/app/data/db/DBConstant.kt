...
object DBConstant {
    ...
    const val CREATE_NEWS_TABLE =
        "CREATE TABLE $TABLE_NEWS ($NEWS_ID INTEGER PRIMARY KEY, $NEWS_GUID TEXT, $NEWS_CATEGORY TEXT, $NEWS_TITLE TEXT UNIQUE, $NEWS_URL TEXT, $NEWS_PUB_DATE INTEGER, $NEWS_THUMB_URL TEXT)"
}